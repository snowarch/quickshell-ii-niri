...
Singleton {
    ...
    function searchIndex(): var {
        ...
        { pageIndex: 14, pageName: root.pages[14].name, section: Translation.tr("Organic edge"), label: Translation.tr("Organic edge"), description: Translation.tr("Reactive screen-edge scenes, connected frames, shapes, semantic color and music response"), keywords: ["organic", "edge", "screen", "scene", "preset", "silk horizon", "aurora rails", "neon frame", "ember pulse", "album aura", "spectrum crown", "ghost frame", "club pulse", "wallpaper tide", "afterglow frame", "shape", "ribbon", "cells", "filament", "join", "connected", "wallpaper", "album", "adaptive", "vivid", "shimmer", "echo", "prism", "bloom", "caustic", "afterglow", "glow", "opacity", "crest", "hue", "color", "colour", "audio", "music", "beat", "pulse", "bass", "treble", "attack", "release", "smoothing", "palette"] },
