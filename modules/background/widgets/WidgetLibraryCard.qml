...
Rectangle {
    ...
    readonly property real cardRadius: Appearance.regaliaEverywhere ? Appearance.regalia.controlRadius
    ...
    border.color: ColorUtils.applyAlpha(Appearance.colors.colPrimary, 0.58)
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            MaterialSymbol {
                ...
                text: root.symbol
                iconSize: 38
                color: root.active ? Appearance.colors.colPrimary : Appearance.colors.colOnLayer1
